...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.hw.dao..*.*(..))")
...
//	}
	...
	@AfterReturning(value = "execution(* com.ssafy.hw..Product*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.hw..Product*.list*(..))", throwing = "exception")
