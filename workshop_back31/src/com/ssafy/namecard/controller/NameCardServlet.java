...
//				cookie.setPath(request.getContextPath());
				...
				response.addCookie(new Cookie("part", part));
				response.addCookie(new Cookie("email", email));
				response.addCookie(new Cookie("phone1", phone1));
				response.addCookie(new Cookie("phone2", phone2));
				response.addCookie(new Cookie("phone3", phone3));
				response.addCookie(new Cookie("address1", address1));
				response.addCookie(new Cookie("address2", address2));
			}
		...
		return "/namecard/cookiedetail.jsp";
