        ...
        $(document).ready(function () {
            $("#loginBtn").click(function () {
                if (!$("#id").val()) {
                    ...
                    $("#writeform").attr("action", "${root}/user/login").submit();
                }
...
<div class="col-lg-11 mx-auto">
	...
	<form align=right id="writeform" method="post">
	...
	<c:if test="${!empty userinfo}">
	<div align="right">${userinfo.name }님 안녕하세요. <a href="${root }/user/logout">로그아웃</a></div>
	</c:if>
	<hr>
</div>
